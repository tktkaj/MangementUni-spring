...
<jsp:include page="../common/header.jsp" />
    ...
    <div class="container">
        <div type="box" id="content" class="header2">
            ...
            <div class="input-group mb-0">
                <input type="text" class="form-control1" value="준비됐다" readonly>
            </div>
            <div class="horizontal-container">
                ...
                <div class="stats-section">
                    <div class="stat-item">
                        <img src="${path}/resources/img/조회수.png" class="button-img" id="contentButton1">
                        <div class="counter" id="contentCounter1">0</div>
                    </div>
                    <div class="stat-item">
                        <img src="${path}/resources/img/추천버튼.png" class="button-img" id="contentButton2">
    ...
    <div class="detailchang">
        <div class="input-group mb-0">
            <input type="text" class="form-control2" value="정말로 잘 됐다" readonly>
        </div>
        <hr style="width: 1000px;">
        <div>
            <div class="comment">
                ...
                <div class="input-group mb-0">
                    <input type="text" class="form-control3" value="정말로 잘 됐다 나도 살려줘" readonly>
                </div>
                <hr style="width: 1000px;">
            </div>
            <div class="comment">
        ...
        <div class="downbtn">
            <button type="button" class="btn3"><img src="${path}/resources/img/글목록.png" width="20" height="20">&nbsp;글 목록</button>
        </div>
    </div>
