				...
				<div class="horizontal-container">
					<div class="profile-section">
						<img src="${path}/resources/img/프로필사진.png" class="프로필사진"
							alt="Profile Image"> <span class="username">ghdgns82</span>
					</div>
					<div class="stats-section">
						<div class="stat-item">
							<img src="${path}/resources/img/조회수.png" class="button-img"
								id="contentButton1">
	...
	<script>
        document.getElementById('postCommentButton').addEventListener('click', function () {
            ...
            if (commentText !== '') {
                ...
                profileImage.src = '${path}/resources/img/프로필사진.png';
                ...
                recommendButton.src = '${path}/resources/img/추천버튼.png';
