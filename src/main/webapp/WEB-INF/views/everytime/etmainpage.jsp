	...
	<div class="container" style="height: 1000px; margin-top:100px;">
        ...
        <div id="content">
            ...
            <div class="list-group">
                ...
                <a href="etdetailview" class="list-group-item list-group-item-action list-group-item-small disabled">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;내용이었던 것 내용이었던 것 내용이었던 것 내용이었던 것
                </a>
                <a href="etdetailview" class="list-group-item list-group-item-action list-group-item-small2 disabled">
