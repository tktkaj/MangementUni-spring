    ...
    <div class="container">
        <div id="content">
            ...
            <div class="list-group">
                ...
                <input type="text" id="Box" class="box-etmywrite" value="&nbsp;내가 쓴글">
            </div>
            ...
            <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action list-group-item-large-etmywrite"
                    aria-current="true" style="margin-top: 5px;">제목이었던 것</a>
                <a href="#" class="list-group-item list-group-item-action list-group-item-small-etmywrite disabled">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;내용이었던 것 내용이었던 것 내용이었던 것 내용이었던 것
                </a>
                <a href="#" class="list-group-item list-group-item-action list-group-item-small2-etmywrite disabled">
            ...
            <button type="button" class="btn1-etmywrite">▼&nbsp;더보기</button>
        </div>
    </div>
