		...
		<form action="${path}/board/list" method="get">
			<div style="text-align: center;">
				<label> <input type="radio" name="searchType" value="title"
					...
					value="content" ${searchType=='content' ? 'checked':''}> 내용
				</label> <label> <input type="radio" name="searchType"
		...
		<!-- 검색창 종료 -->
				...
				<div id="improtant">총 조회 건수 ${ count }건</div>
					<div class="table-responsive">
						...
						<button onclick="location.href='writeinfo'" style="float: right; width: 80px; background-color:  #024C86;color: white;"">글작성</button>
