                ...
                <div class="row sub-news">
                    <div class="col col-12">
                        ...
                        <div class="article main-article">
                            ...
                            <p class="content">'선미-팝'이라고 하는 현상이 어떻게 비전형적인 아이돌의 커리어 모델을 만들 수 있었는가</p>
                            <div class="readmore2">
                                <a href="">read more</a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col col-12">
                        ...
                        <div class="article main-article">
                            ...
                            <p class="content">"기후변화로 인한 재난에 대응하고 지속가능한 미래를 위한 에너지-물 기후기술 혁신"를 주제로 열려</p>
                            <div class="readmore2">
                                <a href="">read more</a>
                            </div>
                        </div>
        ...
        <div class="row new2">
            <div class="col col-3">
                <div class="article main-article">
                    ...
                    <p class="content">"한국 교육의 선두에 있는 미르대 학업뿐만 아니라, 다양한 사람들과 교류할 기회!"</p>
                </div>
                <div class="bottom">
            ...
            <div class="col col-3">
                <div class="article main-article">
                    ...
                    <p class="content">"채식 위주의 식단이 항산화 성분과 항염증 특성으로 인해 노화 방지 효과를 줄 수 있어."</p>
                </div>
                <div class="bottom">
